                ...
                @foreach($payments as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="{{ url('/payments/' . $item->id) }}" accept-charset="UTF-8" style="display:inline" onsubmit="return confirmDelete()">
                                {{ method_field('DELETE') }}
                                {{ csrf_field() }}
                            ...
                            <a href="{{ url('/report/report1/' .$item->id ) }}" title="Edit payments"><button class="btn btn-success"><i class="fa fa-print" aria-hidden="true"></i> Print</button></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
